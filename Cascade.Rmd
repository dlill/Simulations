...
```{r}
obj_alpha2 <- function(pars_opt = pars_opt_0,
...
optim1 <- rbenchmark::benchmark({mstrust(obj_alpha, center =  pars_opt_0+0.5, studyname = "Fits", cores = 1, fits = 1, sd = 0.3)}, replications = 100)

optim2 <- rbenchmark::benchmark({
  optim(pars_opt_0+runif(3,0,10),
        obj_alpha2)}, replications = 100)

optim3 <- rbenchmark::benchmark({
  optim(pars_opt_0+runif(3,0,10),
        obj_alpha2, method = "BFGS")}, replications = 100)
...
optim5 <- rbenchmark::benchmark({
  optim(pars_opt_0+runif(3,0,10),
        obj_alpha2, method = "L-BFGS-B")}, replications = 100)
...
fits1 <- mstrust(obj_alpha, center =  pars_opt_0, samplefun = "runif", studyname = "Fits", cores = 4, fits = 100, max = 10)
fits2 <- mclapply(1:100, function(i) optim(pars_opt_0+runif(3,0,10),obj_alpha2),mc.cores = 4)
fits3 <- mclapply(1:100, function(i) optim(pars_opt_0+runif(3,0,10),obj_alpha2, method = "BFGS"),mc.cores = 4)
fits5 <- mclapply(1:100, function(i) optim(pars_opt_0+runif(3,0,10),obj_alpha2, method = "L-BFGS-B"),mc.cores = 4)
