...
b1 <- rbenchmark::benchmark(obj_alpha(pars_opt = pars_opt_0 + 36 + rnorm(2), mypars = pars))
b2 <- rbenchmark::benchmark(obj_alpha_no_derivs(pars_opt = pars_opt_0 + 36 + rnorm(2), mypars = pars))
