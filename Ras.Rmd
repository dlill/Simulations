...
myfits <- mstrust(obj_alpha, center =  rep(0, length(pars_opt)) %>% set_names(names(pars_opt)), studyname = "Fits", cores = 3, fits = 20, sd = 1, mypars = pars, perturbation_prediction = perturbation_prediction_0, r_kept = r_kept_0)
# myfits %>% as.parframe() 
