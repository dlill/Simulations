...
```{r cluster perturbations by similar matrix outcomes}
cluster_matrices_and_print_perturbations <- function(results_unnested_matrices, alpha, col_start, nclust, which_clust) {
  ...
  augmented <- broom::augment(kclusts, results_unnested_matrices %>% 
    filter(alpha == alpha))
...
cluster_matrices_and_print_perturbations(results_unnested_matrices, 0.5, "up_", 5, 1)
