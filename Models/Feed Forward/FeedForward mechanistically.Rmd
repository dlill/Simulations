...
mymodel     <- mymodel %>% 
  addReaction("z1", "z2", rate = "(y2 * kcat *  z1) / (KM + z1)") # add MM style activation of z via y. 
...
g <-  g0 <- Y(as.eqnvec(structure(obs0, names = modules0)), mymodel, compile = F, modelname = "obsfn0", attach.input = FALSE)
```
...
pars_raw <- c(pars_raw, "kcat" = 0.005, "KM" = 20)
...
which_pars_opt <- c("loga_tox_Cxy", "loga_tox_Cxz", "loga_1","loga_2", "loga_3", "loga_4")[-(3:4)]
