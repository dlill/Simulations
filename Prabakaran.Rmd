...
myplot <- dr_list %>%   
  ...
  scale_alpha_discrete(guide = "none",name = "[ppMEK-ERK] \nadded to", range = c(0.99,1)) +
  scale_x_continuous(breaks = c(-5,0,5))+
  xlab("log(a)")
# plotly::ggplotly(myplot)
myplot
ggsave(plot = myplot,
       filename = paste0("~/Promotion/Writing/Papers/2017 02 MRA optimization procedure Paper/pictures/plots/Prabakaran as phosphatase ", "small width algorithm pos1",".png"),
       width = 10,
       height = 8,
       units = "cm",
       device = "png")
