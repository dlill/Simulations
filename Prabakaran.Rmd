...
pars_opt_0 <- pars_opt <- structure(rep(-750, length(pars_inner_opt_0)), names = paste0("log", names(pars_inner_opt_0)))

pars_0 <- pars <- structure(log(pars_inner_0+.Machine$double.eps), names = paste0("log", names(pars_inner_0))) 
pars_0[names(pars_opt_0)] <- -750
...
pars_perturbed_0 <- pars_perturbed <- c(logm1 = 1.1, logp1 = 1.1)
...
dr_list <- lapply(par_opt_settings, function(i) {
  r_opt_dose_response(which_par = "logk1", 
                      dosages = pars_0["logk1"]+seq(-3,3,by = 1),
