...
obs <- obs0 <- c("x2+a*Cx2y1+a_1*Cx2y1 + a2*Cx2y2+a2_1*Cx2y2",
                 "y2+a*Cx2y1+a_2*Cx2y1 + a2*Cx2y2+a2_2*Cx2y2")
...
r_kept_0 <- r_kept_fun(pars_opt = pars_opt_0[c("loga", "loga2")], obs_fun = g, p_fun = (p_log*p_pert))
