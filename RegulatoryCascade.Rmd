---
title: "RegulatoryCascade-feedback-analysis-pertub-v1k4k7"
author: "Daniel Lill"
output:
  pdf_document:
    keep_tex: yes
...
ic_list_list[[1]] <- ic_list <- list(gainlf = c(0,1,5),
                                     gainuf = c(0,1,5),
                                     gainyf = c(0,1,5))
...
## Setting 2: Medium small complex concentrations
```{r Setting 2}
obs_fun_list[[2]]   <-  g0
...
ic_list_list[[2]] <- ic_list <- list(gainlf = c(0,1,5),
                                     gainuf = c(0,1,5),
                                     gainyf = c(0,1,5))
...
## Setting 3: Medium complex concentrations
```{r Setting 3}
obs_fun_list[[3]]   <-  g0
which_pars_perturbed_list[[3]] <- c("x1", "y1", "z1")
                                       
data <- data_fun(50,50,40,30)
obj <- normL2(data,(x*p_nosyndeg))
myfit <- mstrust(obj, pouter_0, cores = 3, fits = 3, studyname = "FindPars", resultPath = ".Findpars")
...
ic_list_list[[3]] <- ic_list <- list(gainlf = c(0,1,5),
                                     gainuf = c(0,1,5),
                                     gainyf = c(0,1,5))
...
# Setting 4: Large complex concentrations
```{r Setting 4}
obs_fun_list[[4]]   <-  g0
which_pars_perturbed_list[[4]] <- c("x1", "y1", "z1")
                                       
data <- data_fun(50,35,60,30)
obj <- normL2(data,(x*p_nosyndeg))
myfit <- mstrust(obj, pouter_0, cores = 3, fits = 3, studyname = "FindPars", resultPath = ".Findpars")
...
ic_list_list[[4]] <- ic_list <- list(gainlf = c(0,1,5),
                                     gainuf = c(0,1,5),
                                     gainyf = c(0,1,5))
