...
ic_list_list[[1]] <- ic_list <- list(gainlf = c(0,1,2,5),
                                     gainuf = c(0,1,2,5))
...
ic_list_list[[2]] <- ic_list <- list(gainlf = c(0,1,2,5),
                                     gainuf = c(0,1,2,5))
...
ic_list_list[[3]] <- ic_list <- list(gainlf = c(0,1,2,5),
                                     gainuf = c(0,1,2,5))
...
ic_list_list[[4]] <- ic_list <- list(gainlf = c(0,1,2,5),
                                     gainuf = c(0,1,2,5))
